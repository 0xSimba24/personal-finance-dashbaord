        ...
        {data.liabilities.map(l => {
          ...
          return (
            <div key={l.id} style={{ padding: "14px", borderRadius: "8px", background: colors.cardAlt, border: `1px solid ${colors.border}` }}>
              ...
              {(l.linkedAsset || null) !== null ? <div style={{ fontSize: "10px", color: colors.textDim, marginTop: "2px" }}>Secured by: <ECell value={l.linkedAsset || ""} onChange={v => updateItem("liabilities", l.id, "linkedAsset", v)} style={{ fontSize: "10px", color: colors.accent }} /></div>
