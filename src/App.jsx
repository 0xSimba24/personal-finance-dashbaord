        ...
        {data.liabilities.map(l => {
          ...
          return (
            <div key={l.id} style={{ padding: "14px", borderRadius: "8px", background: colors.cardAlt, border: `1px solid ${colors.border}` }}>
              ...
              {l.notes ? <div style={{ display: "inline-block", fontSize: "10px", color: "#c5cae0", background: colors.cardAlt, padding: "2px 8px", borderRadius: "4px", marginTop: "4px" }}><ECell value={l.notes} onChange={v => updateItem("liabilities", l.id, "notes", v)} style={{ fontSize: "10px", color: "#c5cae0", background: "transparent" }} /></div> : <div style={{ marginTop: "2px" }}><span style={{ fontSize: "8px", color: colors.border, cursor: "pointer" }} onClick={() => updateItem("liabilities", l.id, "notes", "Add note...")}>+ note</span></div>}
